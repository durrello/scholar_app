          ...
          InkWell(
              child: Column(
                ...
                onTap: () => Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => new PreviewScreen())),
               // Text("Preview"),
          ),
        ],
      ),
        ...
        child: new ListView(
          children: [
            ...
            DrawerOption(
              ...
              onPressed: () => Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => new AccountScreen())),
            ),
            ...
            DrawerOption(
              ...
              iconData: Icons.sync,
              onPressed: () => Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => new ConnectWith())),
            ),
      ...
      body: GridView.count(
        ...
        children: [
          HomeCard(
            ...
            onPressed: () => Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => new ApplyScreen())),
          ),
          ...
          HomeCard(
            ...
            onPressed: () => Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => new PersonalInfoScreen())),
          ),
          ...
          HomeCard(
            ...
            onPressed: () => Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => new GuardianInfoScreen())),
          ),
          ...
          HomeCard(
            ...
            onPressed: () => Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => new ExperienceScreen())),
          ),
          ...
          HomeCard(
            ...
            onPressed: () => Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => new QualificationScreen())),
          ),
          ...
          HomeCard(
            ...
            onPressed: () => Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => new DocumentScreen())),
          ),
          ...
          HomeCard(
            ...
            onPressed: () => Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => new ApplicationScreen())),
          ),
